...
def crawl_tensor_flow_python_tree_structure(tf_python_root_dir, tf_python_path_list, encoding='utf-8'):
    ...
    hr.create_dir_by_tf_python_api_strecture(tf_python_root_url, intercepted_content, tf_python_root_dir, tf_python_path_list, encoding)


def crawl_keras_tree_structure(keras_root_dir, keras_path_list, encoding='utf-8'):
    ...
    hr.create_dir_by_keras_api_strecture(keras_root_url, div_label_content, keras_root_dir, keras_path_list, encoding)


def crawl_pytorch_tree_structure(keras_root_dir, pytorch_path_list, encoding='utf-8'):
    pytorch_root_url = r'https://pytorch.org/docs/stable/'
    html_content = crawler.crawl(pytorch_root_url, encoding)
    div_label_content = hr.get_element_string_by_class_attribute_first(html_content, r'wy-menu wy-menu-vertical')
    hr.create_dir_by_pytorch_api_strecture(pytorch_root_url, div_label_content, keras_root_dir, pytorch_path_list, encoding)
