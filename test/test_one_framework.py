...
h2m.batch_html_to_markdown_save_source(os.path.join(root_html_dir, keras_dir), os.path.join(root_md_dir, keras_dir),
                                       '.html', '.md', 0, encoding)
mr.batch_latex_to_embedded_html(os.path.join(root_md_dir, keras_dir))
...
# for framework_name, framework_root_url in [[pytorch_dir, pytorch_root_url]]:
# for framework_name, framework_root_url in [[tf_python_dir, tf_python_root_url]]:
for framework_name, framework_root_url in [[keras_dir, keras_root_url]]:
